	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
			...
			req.setAttribute("errorMsgs", errorMsgs);
				...
				if (!errorMsgs.isEmpty()) {
					RequestDispatcher failureView = req
							.getRequestDispatcher("/back_end/chat/select_page.jsp");
		...
		if ("getOne_For_Update".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			req.setAttribute("errorMsgs", errorMsgs);
				...
				/***************************1.接收請求參數****************************************/
				Integer chatMessageId = Integer.valueOf(req.getParameter("chatMessageId"));
				
				/***************************2.開始查詢資料****************************************/
				ChatMessageService chatSvc = new ChatMessageService();
				ChatMessageVO chatMessageVO = chatSvc.getOneChatMessage(chatMessageId);
		...
		if ("update".equals(action)) { // 來自update_chat_input.jsp的請求
...
req.setAttribute("empVO", empVO); // 含有輸入格式錯誤的empVO物件,也存入req
				...
				String url = "/emp/listOneEmpChat.jsp";
